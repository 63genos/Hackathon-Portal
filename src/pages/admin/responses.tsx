...
const CustomHeadComponent: React.FC<CustomHeadProps> = ({ title }) => {
    useEffect(() => {
...
const Responses: React.FC = () => {
    ...
    return (
        <div>
            <CustomHeadComponent title='Hackathon Admin | E-Cell IIT Hyderabad - NPCI' description='Welcome to the Admin Portal of E-Cell IIT Hyderabad & NPCI collaborative Hackathon.' />
