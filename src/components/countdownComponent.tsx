...
const Countdown: React.FC<CountdownProps> = ({ targetDate }) => {
    const [countdownD, setCountdownDay] = useState<string>('00');
    const [countdownH, setCountdownHour] = useState<string>('00');
    const [countdownM, setCountdownMin] = useState<string>('00');
    const [countdownS, setCountdownSec] = useState<string>('00');
