...
const TeamsModal: React.FC<TeamsModalProps> = ({ isOpen, onClose, members, name }) => {
        ...
        <Center>
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent bg="#101232" borderRadius="md">
                    <ModalHeader ml="16px" mt="12px" textAlign="start" color="white" fontSize="2rem" fontWeight="medium">
                        {`Team: ${name}`}
                    </ModalHeader>
                    <ModalBody ml="16px" textAlign="start" mt={2}>
                        <Stack direction="column" w="100%">
                            {members.map((user, index) => (
                                <React.Fragment key={index}>
                                    <Stack mt="0px" mb="24px" direction="row" spacing={0} align="center">
                                        {user.isLeader ? (
                                            <svg width="46" height="45" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <circle cx="37.5" cy="8.5" r="7.5" fill="#FFC700" stroke="black" strokeWidth="2" />
                                        ...
                                        <Stack ml="12px" direction="column" spacing={0} flex="1">
